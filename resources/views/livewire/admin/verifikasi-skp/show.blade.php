                  ...
                  @forelse ($pendingSkps as $skp)
                     ...
                     >
                        ...
                        <td class="py-5 pl-4 text-right">
                           <button
                              class="bg-primary hover:bg-opacity-90 inline-flex cursor-pointer items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-semibold text-white transition"
                           >
