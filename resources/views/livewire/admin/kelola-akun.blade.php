<div>
    ...
    <div class="py-6 pl-11 pr-7 flex justify-between items-center bg-white">
        <div>
            <h1 class="text-2xl font-bold text-judul">Kelola Akun Mahasiswa</h1>
    ...
    <div class="py-7 pl-11 pr-7 bg-background min-h-screen">
        ...
        <div class="bg-white rounded-2xl border border-border-custom p-6 shadow-sm">
            ...
            <div class="flex justify-between items-center mb-5">
                ...
                {{-- Tombol Tambah Akun --}}
                <button class="flex items-center gap-2 bg-primary text-white px-4 py-2 rounded-lg font-medium hover:bg-opacity-90 transition shadow-sm text-xs cursor-pointer">
